        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">
              How <strong className="text-green-600">biO</strong>ptimizers works
            </h2>
            <p className="text-xl text-black">
              Here's just a tiny sample of what you'll be seeing over the next
              12 weeks
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-gradient-to-r from-yellow-300 via-green-200 to-green-600 rounded shadow-xl">
              <svg
              ...
              <h4 className="text-lg font-bold eading-snug tracking-tight mb-1">
                How to turn the tide against Uncontrollable Food Cravings
              </h4>
            </div>

            {/* 2nd item */}
            <div className="relative flex flex-col items-center p-6 bg-gradient-to-r from-yellow-300 via-green-200 to-green-600 shadow-xl">
              <svg
                className="w-16 h-16 p-1 -mt-1 mb-2"
                viewBox="0 0 64 64"
                xmlns="http://www.w3.org/2000/svg"
