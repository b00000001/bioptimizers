    ...
    <section id="newsletter">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          {/* CTA box */}
          <div
            className="relative bg-green-700 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden"
            data-aos="zoom-y-out"
          >
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">
                  Yes, I want to Enhance My Health
                </h3>
                <p className="text-gray-300 text-lg mb-6">
                  Enter your email address below and click the 'Double My
                  Energy' button.
                </p>
                ...
                <form className="w-full lg:w-auto">
                  ...
                  <p className="text-sm text-white mt-3">
                    ...
                    <a
                      ...
                      href="https://bioptimizers.com/privacy-policy"
                    >
                      here
                    </a>
                  </p>
